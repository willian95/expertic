                     ...
                     <div class="row justify-content-center">
                        <div class="col-12">
                           <div class="form-group">
                              ...
                              <input type="text" v-model="section" class="form-control" id="section" v-bind:class="{ 'is-invalid': errors.hasOwnProperty('section') }">
                              <small v-if="errors.hasOwnProperty('section')" class="text-danger ml-2">@{{ errors['section'][0] }}</small>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <table class="table table-hover m-b-0">
                        <thead>
                           <tr>
                              ...
                              <th class="adjust-tr-80">Sección</th>
                              <th class="adjust-tr-10">Acciones</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr  v-for="(sectionItem,index) in    Sections.sections">
                              <td>@{{sectionItem.num}}</td>
                              <td>
                                 <p>@{{sectionItem.section}}</p>
                              </td>
                              <td>
                                 <button class="btn btn-info" @click="captureRecord(sectionItem)">
                                 <i class="zmdi zmdi-edit"></i>
                                 </button>
                                 <button class="btn btn-secondary"  @click="destroy(sectionItem.id)">
            ...
            self.loading = true;
                  ...
                  axios.post('{{ url("getSections") }}', {
                     ...
                     if(response.data.success==true){
                        ...
                        self.paginate=response.data.Sections.paginate;
