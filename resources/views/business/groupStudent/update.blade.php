                  ...
                  <div class="row justify-content-center align-items-center pt-2 pl-4 pr-4">
                     <div class="col-12 col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="period_id"  v-bind:class="{ 'is-invalid': errors.hasOwnProperty('period_id') }" disabled>
                     ...
                     <div class="col-12 col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="level_id"  v-bind:class="{ 'is-invalid': errors.hasOwnProperty('level_id') }" disabled>
                              <option value="">Seleccione</option>
                     ...
                     <div class="col-12 col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="section_id"  v-bind:class="{ 'is-invalid': errors.hasOwnProperty('section_id') }" disabled>
                              <option value="">Seleccione</option>
                      ...
                      <table class="table table-hover m-b-0">
                        ...
                        <tbody>
                          <tr  v-for="(stud,index) in students">
                            ...
                            <td>
                              <button class="btn btn-secondary" @click="RemoveStudent(stud.id,index)">
...
<script>
   const business = new Vue({
       ...
       data:{
            ...
            DataGroupStudents:{!! $DataGroupStudents ? $DataGroupStudents : "''"!!},
       ...
       mounted(){
          ...
          this.period_id=this.DataGroupStudents.period_id;

          this.level_id=this.DataGroupStudents.level_id;

          this.section_id=this.DataGroupStudents.section_id;

          this.students=this.DataGroupStudents.students;
       ...
       methods:{
         ...
         AddStudent(){
           ...
           if(this.student==''){
            ...
            self.loading = true;
                  ...
                  axios.post('{{ url("AddStudentGroup") }}', {
                  ...
                  axios.post('{{ url("deleteStudent") }}', {
                     ...
                     if(response.data.success==true){
                        ...
                        if(response.data.redirect==0){
                           ...
                           Swal.fire('Eliminado!','El registro ha sido eliminado, Ya no posee estudiantes asociados (Grupo Eliminado)','success').then(function() {
        ...
        async getGroupStudents(){
            ...
            self.loading = true;
                  ...
                  axios.post('{{ url("getGroupStudents2") }}', {
                     ...
                     if(response.data.success==true){
                        ...
                        self.period_id=response.data.DataGroupStudents.period_id;

                        self.level_id=response.data.DataGroupStudents.level_id;

                        self.section_id=response.data.DataGroupStudents.section_id;

                        self.students=response.data.DataGroupStudents.students;
