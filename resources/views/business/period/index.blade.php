                     ...
                     <div class="row justify-content-center">
                        <div class="col-12">
                           <div class="form-group">
                              ...
                              <small v-if="errors.hasOwnProperty('period')" class="text-danger ml-2">@{{ errors['period'][0] }}</small>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <table class="table table-hover m-b-0">
                        ...
                        <tbody>
                           <tr  v-for="(periodItem,index) in Periods.periods">
                              ...
                              <td>
                                 <button class="btn btn-info" @click="captureRecord(periodItem)">
                                 <i class="zmdi zmdi-edit"></i>
                                 </button>
                                 <button class="btn btn-secondary"  @click="destroy(periodItem.id)">
   ...
   const business = new Vue({
       ...
       methods:{
         ...
         changePage(page){
            ...
            this.getPeriods(page);
   
         },//changePage()
   
         async getPeriods(page){
   
            let self = this;
   
            self.loading = true;
   
                  axios.post('{{ url("getPeriods") }}', {
                     ...
                     if(response.data.success==true){
                        ...
                        self.paginate=response.data.Periods.paginate;
