            ...
            <div class="col-12 col-lg-10 col-md-10">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title mt-3">Registrar Prestamo</h5>
                  </div>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-info" @click="toggleModal()">Prestar</button>                  
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <table class="table table-hover m-b-0">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-center">Prestado</td>
                              <td class="text-center">
                                 <button class="btn btn-info" title="Entregar">
                           ...
                           <tr>
                              ...
                              <td class="text-center">
                                 <button class="btn btn-info" title="Entregar" disabled>
                                    <i class="zmdi zmdi-check"></i>
                                 </button>
                              </td>
                           </tr>                             
