                  ...
                  <div class="row align-items-center pl-4 pr-4 mb-4">
                     <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="period_id" v-bind:class="{ 'is-invalid': errors.hasOwnProperty('period_id') }" @change="getLevels" disabled>
                     ...
                     <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="level_id" v-bind:class="{ 'is-invalid': errors.hasOwnProperty('level_id') }" @change="getSections" disabled>
                              <option value="">Seleccione</option>
                     ...
                     <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="section_id" v-bind:class="{ 'is-invalid': errors.hasOwnProperty('section_id') }" @change="getStudents" disabled>
                              <option value="">Seleccione</option>
                     ...
                     <div class="col-12 col-md-6 col-lg-3">
                        <div class="form-group">
                           ...
                           <select class="form-control custom-select" v-model="subject_id" v-bind:class="{ 'is-invalid': errors.hasOwnProperty('subject_id') }" disabled>
                              <option value="">Seleccione</option>
...
<script>
   ...
   const teacher = new Vue({
        ...
        data:{
         ...
         DataEvaluations:{!! $DataEvaluations ? $DataEvaluations : "''"!!},
       ...
       mounted(){
          ...
          this.period_id=this.DataEvaluations.period_id;

          this.getLevels();

          this.level_id=this.DataEvaluations.level_id;

          this.subject_id=this.DataEvaluations.subject_id;

          this.date=this.DataEvaluations.date;

          this.start_time=this.DataEvaluations.start_time;

          this.end_time=this.DataEvaluations.end_time;
          ...
          async getSections(){
             ...
             axios.post('{{ url("/business/groupStudent/getSections") }}', {
                ...
                if(response.data.success==true){
                  ...
                  self.section_id=self.DataEvaluations.section_id;
          ...
          async getStudents(){
             ...
             axios.post('{{ url("/business/groupStudent/getStudents") }}', {
                ...
                if(response.data.success==true){
                  ...
                  self.students_evaluations=self.DataEvaluations.students;
          ...
          async update(){
           ...
           axios.post('{{ url("updateEvaluation") }}', {
              ...
              if(response.data.success==true){
                  ...
                  Swal.fire('Información','Actualización Satisfactoria','success').then(function() {
