...
class StoreRepresentativeViewfinderPost extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'representative.phone'=>'required|min:11|max:12',
        ...
        return [
            ...
            'representative.phone.min'=>'Cantidad de digitos incompleta',
            'representative.phone.max'=>'Excede la cantidad de digitos', 
            ...
            'representative.email.unique'=>'El campo email ya existe en la base de datos',
